...
import amb.ml.GP.ec.steadystate.SteadyStateEvolutionState;
import amb.ml.GP.ec.steadystate.QueueIndividual;
...
public class SlaveMonitor
    ...
    */
    void notifySlaveAvailability( SlaveConnection slave, final Job job, EvolutionState state )
        ...
        if( state instanceof amb.ml.GP.ec.steadystate.SteadyStateEvolutionState )
            {
