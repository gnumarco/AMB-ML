...
import amb.ml.GP.ec.*;
import amb.ml.GP.ec.coevolve.GroupedProblemForm;
import amb.ml.GP.ec.simple.SimpleProblemForm;
import amb.ml.GP.ec.simple.SimpleEvolutionState;
        ...
        for (x = 0; x < args.length - 1; x++)
            if (args[x].equals(A_FILE))
                ...
                try
                    ...
                    parameters.set(new Parameter(amb.ml.GP.ec.EvolutionState.P_EVALUATOR).push(amb.ml.GP.ec.Evaluator.P_IAMSLAVE), "true");
                    break;
                    }
        ...
        while (true)
            ...
            try
                ...
                try
                    ...
                    // by default.
                    output.addLog(amb.ml.GP.ec.util.Log.D_STDOUT, false);
                    output.addLog(amb.ml.GP.ec.util.Log.D_STDERR, true);
                    ...
                    state = (EvolutionState)
                        parameters.getInstanceForParameter(new Parameter(amb.ml.GP.ec.Evolve.P_STATE),null,
