...
import amb.ml.GP.ec.steadystate.*;
import amb.ml.GP.ec.*;
import amb.ml.GP.ec.simple.*;
import amb.ml.GP.ec.gp.*;
import amb.ml.GP.ec.util.*;
import java.io.*;
import amb.ml.GP.ec.gp.koza.KozaFitness;

/**
 *
 * @author marc
 */
public class AMBStatistics extends amb.ml.GP.ec.simple.SimpleStatistics {
    ...
    public void postEvaluationStatistics(final EvolutionState state) {
        ...
        for (int x = 0; x < state.population.subpops.length; x++) {
            ...
            for (int y = 0; y < state.population.subpops[x].individuals.length; y++) {
                ...
                //Best 10
                if (cptInd < 10) {
                    if (((amb.ml.GP.ec.gp.koza.KozaFitness) state.population.subpops[x].individuals[y].fitness).adjustedFitness() < minFit) {
                        minFit = ((amb.ml.GP.ec.gp.koza.KozaFitness) state.population.subpops[x].individuals[y].fitness).adjustedFitness();
                    }
